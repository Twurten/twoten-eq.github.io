...
function pause() {
  ...
  if (paused) {
    document.getElementById("pause").style =
      "transform: rotate(90deg); clip-path: polygon(50% 0%, 0% 100%, 100% 100%);";
  } else {
    document.getElementById("pause").style =
      "transform: rotate(0deg); clip-path: none";
  }
}
...
function changespeed() {
  ...
  switch(speedt){
    case 1:
      document.getElementById("speed").firstElementChild.innerHTML="X1"
      speed=10
      break;
    case 2:
      document.getElementById("speed").firstElementChild.innerHTML="X2"
      speed=5
      break;
    case 0:
      document.getElementById("speed").firstElementChild.innerHTML="X.5"
      speed=20
      break;
  }
...
function repaint() {
  ...
  for (let i = 0; i < generation.length; i++) {
    for (let j = 0; j < generation[0].length; j++) {
      if (generation[i][j] == 1) ctx.fillRect(i * 10, j * 10, cs, cs);
    }
  }
}
